# OBSS SAHI Tool
# Code written by Sarthak Tripathi, 2024.
...
class TorchVisionDetectionModel(DetectionModel):
    ...
    def _create_object_prediction_list_from_original_predictions(
        ...
        for image_predictions in original_predictions:
            ...
            scores = image_predictions["keypoints_scores"].cpu().detach().numpy()
            ...
            points = list(image_predictions["keypoints"][selected_indices].cpu().detach().numpy())
